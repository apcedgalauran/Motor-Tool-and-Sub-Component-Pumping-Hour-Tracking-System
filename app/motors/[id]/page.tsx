...
import { MotorAssemblyTab } from '@/components/MotorAssemblyTab';
import { MotorDetailTabs } from '@/components/MotorDetailTabs';
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div>
        <HoursForm
          ...
          assembledSubComponents={activeAssemblies.map((a) => ({
            id: a.subComponent.id,
            type: a.subComponent.type,
            serialNumber: a.subComponent.serialNumber,
            cumulativeHours: a.subComponent.cumulativeHours,
          }))}
        />
      </div>
    </div>
